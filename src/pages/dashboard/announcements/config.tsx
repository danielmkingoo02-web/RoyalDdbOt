...
export const ANNOUNCEMENTS: Record<string, TAnnouncement> = {
    ...
    MOVING_STRATEGIES_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Moving strategies to Royal Trading Tools'),
            ...
            numbered_content: [
                {
                    id: 0,
                    text: localize('Download your strategy in XML format and import it to Royal Trading Tools.'),
                },
                {
                    id: 1,
            ...
            plain_text: [
                {
                    ...
                    text: (
                        <Localize
                            i18n_default_text='<0>Note</0>: Uploading complex strategies may take some time. Saving them from Royal Trading Tools ensures quicker access later. If you have questions, contact us via <1/>.'
    ...
    BLOCKLY_ANNOUNCE: {
        announcement: {
            ...
            title: (
                <Localize
                    i18n_default_text='We have updated our Blockly system in Royal Trading Tools from <0>version 3 to version 10</0>. This brings:'
                    components={[<strong key={0} />]}
                />
            ),
            numbered_content: [
    ...
    ACCUMULATOR_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Accumulators now on Royal Trading Tools'),
    ...
    PWA_INSTALL_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Install Royal Trading Tools as an App'),
            ...
            content: [
                {
                    id: 0,
                    text: localize(
                        'Install Royal Trading Tools directly on your device for faster access and better performance.'
                    ),
                },
                {
                    id: 1,
...
export const BOT_ANNOUNCEMENTS_LIST: TAnnouncementItem[] = [
    {
        id: 'PWA_INSTALL_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Install Royal Trading Tools as an App'),
        message: localize('Get faster access and better performance by installing Royal Trading Tools on your device.'),
    ...
    },
    {
        id: 'MOVING_STRATEGIES_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Moving strategies to Royal Trading Tools'),
    ...
    },
    {
        ...
        message: localize('We have updated our Blockly system in Royal Trading Tools from version 3 to version 10.'),
    ...
    },
    {
        id: 'ACCUMULATOR_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Accumulators is now on Royal Trading Tools'),
