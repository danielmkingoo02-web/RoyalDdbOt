...
export const SIDEBAR_INTRO = (): TSidebarItem[] => [
    {
        label: localize('Welcome to Royal Trading Tools!'),
        content: [
            {
                data: localize(
    ...
    },
    {
        ...
        content: [{ data: localize('Royal Trading Tools - your automated trading partner') }],
        link: true,
    },
    {
        label: localize('FAQs'),
        content: [
            {
                data: localize('What is Royal Trading Tools?'),
                faq_id: 'faq-0',
            },
            {
